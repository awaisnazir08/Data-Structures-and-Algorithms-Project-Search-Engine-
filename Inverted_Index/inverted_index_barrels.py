...
class InvertedIndex:
    ...
    def __init__(self):
        ...
        for i in range(1, self.number_of_inverted_index_barrels + 1):
            self.inverted_index_file_paths.append(f'Inverted_Index/Inverted_index_files/inverted_index_barrel_{i}.json')
...
for file_path in json_foward_index_files:
    forward_index = load_forward_index(os.path.join(json_forward_index_dir,file_path))
